    ...
    <div class="container">
      ...
      <div class="w-full border-t border-slate-700 pt-6">
        ...
        <p class="text-center text-xs font-medium text-slate-500">
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> &nbsp All rights reserved is made by <a href="https://github.com/dins-yats" target="_blank" class="font-bold text-primary">SDN Macang Sakti</a>
        </p>
      </div>
    </div>
  </footer>
