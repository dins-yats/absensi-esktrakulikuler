...
<nav class="bg-transparent shadow-lg shadow-slate-800 border-gray-200 dark:bg-gray-900">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
       <img src="/img/macangsakti.png" class="h-6 me-2 sm:h-7" alt="Flowbite Logo" />
        <span class="self-center text-2xl font-semibold whitespace-nowrap text-yellow-400 dark:text-white">SDN Macang Sakti</span>
    </a>
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        ...
        <li>
          <a href="dokumentasi" class=" {{ Request::is('dokumentasi') ? 'visited:text-amber-400 bg-blue-600' : ''}} block py-2 px-3 text-zinc-200 rounded md:bg-transparent  hover:bg-slate-700 md:hover:bg-transparent md:border-0 md:hover:text-yellow-400 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Ekstrakurikuler</a>
        </li>
        <li>
          <a href="logharian" class=" {{ Request::is('logharian') ? 'visited:text-amber-400 bg-blue-600' : ''}} block py-2 px-3 text-zinc-200 rounded md:bg-transparent  hover:bg-slate-700 md:hover:bg-transparent md:border-0 md:hover:text-yellow-400 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Log Kehadiran</a>
        </li>
